...
import { g as getDefaultFormat, f as formatDate, b as isValidDate, p as parseToDayjs, a as formatTime } from '../../_chunks/dep-81a8909d.js';
...
function useSingleInput(props) {
  ...
  if (props.multiple) {
    ...
    tagInputProps = {
      clearable: props.clearable,
      suffixIcon: (_props$suffixIcon2 = props.suffixIcon) !== null && _props$suffixIcon2 !== void 0 ? _props$suffixIcon2 : /* @__PURE__ */React.createElement(CalendarIcon$1, null)
    };
  }
  useEffect(function () {
    if (!value) {
