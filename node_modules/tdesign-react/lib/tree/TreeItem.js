...
import React, { forwardRef, useRef, useEffect, useState, isValidElement } from 'react';
...
import 'dayjs';
import '../_chunks/dep-5ac87a7c.js';
...
import '../_chunks/dep-7b3acdc2.js';
...
import './hooks/TreeDraggableContext.js';
...
var TreeItem = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  var renderLine = function renderLine() {
    ...
    if (node.parent && node.tree) {
      ...
      return /* @__PURE__ */React.createElement("span", {
        className: classNames(treeClassNames.line, _defineProperty(_defineProperty({}, treeClassNames.lineIsLeaf, node.vmIsLeaf || !iconVisible), treeClassNames.lineIsFirst, node.vmIsFirst && iconVisible)),
        style: styles,
  ...
  var renderLabel = function renderLabel() {
    ...
    if (label instanceof Function) {
      var _node$getModel = node.getModel(),
        ...
        rest = _objectWithoutProperties(_node$getModel, _excluded);
    ...
    return /* @__PURE__ */React.createElement("span", {
      ...
      "date-target": "label",
      className: labelClasses,
      title: /*#__PURE__*/isValidElement(node.label) && !((_node$data = node.data) !== null && _node$data !== void 0 && _node$data.text) ? "" : String(((_node$data2 = node.data) === null || _node$data2 === void 0 ? void 0 : _node$data2.text) || node.label)
  ...
  var childrenKey = ((_props$keys = props.keys) === null || _props$keys === void 0 ? void 0 : _props$keys.children) || "children";
  return /* @__PURE__ */React.createElement("div", {
    ref: composeRefs(ref, nodeRef),
    "data-value": node.value,
    "data-level": level,
    className: classNames(treeClassNames.treeNode, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, treeClassNames.treeNodeOpen, node.expanded && (typeof node.data[childrenKey] === "boolean" ? node.data[childrenKey] : node.data[childrenKey] !== void 0)), treeClassNames.actived, node.isActivable() ? node.actived : false), treeClassNames.disabled, node.isDisabled()), treeClassNames.treeNodeDraggable, node.isDraggable()), treeClassNames.treeNodeDragging, isDragging), treeClassNames.treeNodeDragTipTop, isDragOver && dropPosition < 0), treeClassNames.treeNodeDragTipBottom, isDragOver && dropPosition > 0), treeClassNames.treeNodeDragTipHighlight, !isDragging && isDragOver && dropPosition === 0)),
    style: {
      "--level": level,
      boxShadow: ""
    },
