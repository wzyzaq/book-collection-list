...
import { C as Color, g as getColorObject } from '../../../_chunks/dep-60aa0369.js';
import { D as DEFAULT_LINEAR_GRADIENT, a as DEFAULT_COLOR, b as DEFAULT_SYSTEM_SWATCH_COLORS, T as TD_COLOR_USED_COLORS_MAX_SIZE } from '../../../_chunks/dep-9f7e628d.js';
import { i as initColorFormat } from '../../../_chunks/dep-dfad3538.js';
...
import '../../../_chunks/dep-485e026a.js';
...
var Panel = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  var SwatchesArea = /*#__PURE__*/React.memo(function () {
    ...
    if (onlySupportGradient) {
      systemColors = systemColors.filter(function (color) {
        return Color.isGradientColor(color);
      });
    }
