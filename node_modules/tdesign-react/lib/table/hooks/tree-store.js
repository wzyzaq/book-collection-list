...
import { i as isRowSelectedDisabled } from '../../_chunks/dep-565236f6.js';
...
var TableTreeStore = /*#__PURE__*/function () {
  ...
  return _createClass(TableTreeStore, [{
    ...
    value: function updateData(rowValue, newRowData, dataSource, keys) {
      var newRowValue = get(newRowData, keys.rowKey);
      ...
      if (get(newRowData, keys.childrenKey) === true) {
        ...
        if (oldChildren !== null && oldChildren !== void 0 && oldChildren.length) {
          for (var i = 0, len = oldChildren.length; i < len; i++) {
            var rowValue2 = get(oldChildren[i], keys.rowKey);
      ...
      if (rowState.parent) {
        ...
        var index = siblings.findIndex(function (item) {
          return get(item, keys.rowKey) === rowValue;
        });
    ...
    value: function appendTo(rowValue, newData, dataSource, keys) {
      ...
      for (var i = 0, len = tmpData.length; i < len; i++) {
        ...
        var newRowValue = get(oneData, keys.rowKey);
      ...
      var _expandLoop = function expandLoop(dataSource2, keys2) {
        ...
        for (var i = 0, len = dataSource2.length; i < len; i++) {
          ...
          if (children !== null && children !== void 0 && children.length && !originalExpanded) {
            ...
            _expandLoop(children, keys2, newData, originalExpanded, state);
          }
        }
        return newData;
      };
      return _expandLoop(dataSource, keys);
    }
  }, {
    key: "foldAll",
...
export { TABLE_TREE_ERROR_CODE_NOT_SAME_LEVEL, clearRowExpandLength, TableTreeStore as default, updateChildrenRowState, updateRowData, updateRowExpandLength, updateRowIndex };
