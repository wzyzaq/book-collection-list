...
import { getValueToOption } from '../util/helper.js';
      ...
      if (value !== void 0 && value !== null) {
        if (valueType === "value") {
          return [valueToOption[value] || oldSelectedOptions.find(function (option) {
            return get(option, valueKey) === value;
          }) || _defineProperty(_defineProperty({}, valueKey, value), labelKey, value)].filter(Boolean);
        }
        return [value];
      }
      return [];
