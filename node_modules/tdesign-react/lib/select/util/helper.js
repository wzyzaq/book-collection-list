...
function setValueToOptionFormOptionDom(dom, valueToOption, keys) {
  ...
  valueToOption[value] = _objectSpread(_objectSpread({}, dom.props), {}, _defineProperty(_defineProperty({}, (keys === null || keys === void 0 ? void 0 : keys.value) || "value", value), (keys === null || keys === void 0 ? void 0 : keys.label) || "label", label || children || value));
}
