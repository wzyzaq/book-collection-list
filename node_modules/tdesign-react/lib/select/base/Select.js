...
import { getSelectValueArr, getSelectedOptions } from '../util/helper.js';
...
var Select = forwardRefWithStatics(function (originalProps, ref) {
      ...
      if (option.group) {
        option.children.forEach(function (item) {
          if (!item.disabled && !item.checkAll) {
            values.push(valueType === "object" ? item : item[(keys === null || keys === void 0 ? void 0 : keys.value) || "value"]);
          }
        });
      } else if (!option.disabled && !option.checkAll) {
        values.push(valueType === "object" ? option : option[(keys === null || keys === void 0 ? void 0 : keys.value) || "value"]);
      }
    });
  ...
  var handleFilter = function handleFilter(value2) {
    ...
    tmpPropOptions.forEach(function (option) {
      if (option.group) {
