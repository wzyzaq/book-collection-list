...
import { get, isString, isObject, isFunction, merge } from 'lodash-es';
...
var FormItem = /*#__PURE__*/forwardRef(function (originalProps, ref) {
  ...
  var snakeName = [].concat(formListName, name).filter(function (item) {
    return item !== void 0;
  }).toString();
  ...
  function getInnerRules(name2, formRules, formListName2, formListRules2) {
    if (Array.isArray(name2)) {
      return get(formRules === null || formRules === void 0 ? void 0 : formRules[formListName2], name2) || get(formListRules2, name2) || [];
    }
