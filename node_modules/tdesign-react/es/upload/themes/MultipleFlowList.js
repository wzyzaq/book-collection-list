...
import { BrowseIcon, DeleteIcon, CheckCircleFilledIcon, ErrorCircleFilledIcon, TimeFilledIcon, FileExcelIcon, FilePdfIcon, FileWordIcon, FilePowerpointIcon, FileIcon, VideoIcon } from 'tdesign-icons-react';
import { a as abridgeName, F as FILE_PDF_REGEXP, b as FILE_EXCEL_REGEXP, c as FILE_WORD_REGEXP, d as FILE_PPT_REGEXP, V as VIDEO_REGEXP, I as IMAGE_REGEXP, r as returnFileSize } from '../../_chunks/dep-6cdb2112.js';
...
import 'react-dom';
import '../../_chunks/dep-a89e29f0.js';
...
var ImageFlowList = function ImageFlowList(props) {
  ...
  var renderImgItem = function renderImgItem(file, index) {
    ...
    }, file.status === "progress" && /* @__PURE__ */React.createElement("div", {
      className: "".concat(uploadPrefix, "__card-status-wrap ").concat(uploadPrefix, "__").concat(props.theme, "-progress")
    }, iconMap[file.status], /* @__PURE__ */React.createElement("p", null, textMap[file.status], props.showUploadProgress && " ".concat(file.percent, "%"))), file.status === "fail" && /* @__PURE__ */React.createElement("div", {
      className: "".concat(uploadPrefix, "__card-status-wrap ").concat(uploadPrefix, "__").concat(props.theme, "-fail")
    }, iconMap[file.status], /* @__PURE__ */React.createElement("p", null, ((_file$response = file.response) === null || _file$response === void 0 ? void 0 : _file$response.error) || textMap[file.status])), (["waiting", "success"].includes(file.status) || !file.status && file.url) && /* @__PURE__ */React.createElement(Image, {
    ...
    }, (file.url || file.raw) && !["progress", "fail"].includes(file.status) && /* @__PURE__ */React.createElement("span", {
      className: "".concat(uploadPrefix, "__card-mask-item")
    }, /* @__PURE__ */React.createElement(BrowseIcon$1, {
    ...
    }, /* @__PURE__ */React.createElement(DeleteIcon$1, null)))), props.showImageFileName && /* @__PURE__ */React.createElement("p", {
      className: classNames(["".concat(uploadPrefix, "__card-name"), "".concat(uploadPrefix, "__flow-status")])
  ...
  var renderStatus = function renderStatus(file) {
    ...
    }, iconMap[file.status], /* @__PURE__ */React.createElement("span", {
  ...
  function getFileThumbnailIcon(fileType) {
    if (FILE_PDF_REGEXP.test(fileType)) {
      return /* @__PURE__ */React.createElement(FilePdfIcon$1, null);
    }
    if (FILE_EXCEL_REGEXP.test(fileType)) {
      return /* @__PURE__ */React.createElement(FileExcelIcon$1, null);
    }
    if (FILE_WORD_REGEXP.test(fileType)) {
      return /* @__PURE__ */React.createElement(FileWordIcon$1, null);
    }
    if (FILE_PPT_REGEXP.test(fileType)) {
      return /* @__PURE__ */React.createElement(FilePowerpointIcon$1, null);
    }
    if (VIDEO_REGEXP.test(fileType)) {
      return /* @__PURE__ */React.createElement(VideoIcon$1, null);
    }
    return /* @__PURE__ */React.createElement(FileIcon$1, null);
  }
  ...
  var renderFileList = function renderFileList() {
    ...
    return /* @__PURE__ */React.createElement("table", _objectSpread({
      ...
      var thumbnailNode = showThumbnail ? /* @__PURE__ */React.createElement("div", {
        className: "".concat(uploadPrefix, "__file-info")
      }, renderFileThumbnail(file), fileName) : fileName;
      var fileNameNode = file.url ? /* @__PURE__ */React.createElement(Link, {
        href: file.url,
        target: "_blank",
        hover: "color"
      ...
      }, fileNameNode), /* @__PURE__ */React.createElement("td", null, returnFileSize(file.size)), /* @__PURE__ */React.createElement("td", null, renderStatus(file)), disabled ? null : deleteNode);
    })));
  };
  var renderImageList = function renderImageList() {
    if (props.fileListDisplay) {
      return parseTNode(props.fileListDisplay, _objectSpread(_objectSpread({}, props), {}, {
        files: displayFiles,
        dragEvents: innerDragEvents
      }));
    }
  ...
  }, innerDragEvents), displayFiles.length ? renderImageList() : renderEmpty()), props.theme === "file-flow" && (displayFiles.length ? renderFileList() : /* @__PURE__ */React.createElement("div", _objectSpread({
    className: cardClassName
  }, innerDragEvents), renderEmpty())), !props.autoUpload && /* @__PURE__ */React.createElement("div", {
    className: "".concat(uploadPrefix, "__flow-bottom")
  }, renderCancelUploadButton(), renderUploadButton()), /* @__PURE__ */React.createElement(ImageViewer, _objectSpread({
