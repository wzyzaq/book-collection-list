...
import { g as getIEVersion } from '../_chunks/dep-a0aea470.js';
...
var BaseTable = /*#__PURE__*/forwardRef(function (originalProps, ref) {
  ...
  var renderAffixedFooter = function renderAffixedFooter() {
    ...
    var affixedFooter = Boolean((virtualConfig.isVirtualScroll || props.footerAffixedBottom) && ((_props$footData = props.footData) === null || _props$footData === void 0 ? void 0 : _props$footData.length) && tableWidth.current) && /* @__PURE__ */React.createElement(Affix, _objectSpread(_objectSpread({
      ...
      style: {
        marginTop: "".concat(-1 * ((tableFootHeight || 0) + marginScrollbarWidth), "px")
      }
  ...
  var affixedFooterContent = useMemo(renderAffixedFooter, [showAffixFooter, isFixedHeader, rowAndColFixedPosition, spansAndLeafNodes, columns, thWidthList, tableBaseClass, tableElementStyles, tableElmWidth, affixFooterRef, affixedLeftBorder, bordered, isWidthOverflow, scrollbarWidth, tableElmClasses, tableFootHeight, tableWidth, virtualConfig.isVirtualScroll, props.rowKey, props.footData, props.rowAttributes, props.rowClassName, props.footerSummary, props.footerAffixedBottom, props.rowspanAndColspanInFooter, tableWidth.current]);
