...
function TableFilterController(props) {
  ...
  var getFilterContent = function getFilterContent(column2) {
    ...
    }, /* @__PURE__ */React.createElement(FilterComponent, _objectSpread(_objectSpread({
  ...
  var getBottomButtons = function getBottomButtons(column2) {
    ...
    }, locale.resetText), /* @__PURE__ */React.createElement(Button, {
      theme: "primary",
      size: "small",
      onClick: function onClick() {
  ...
  var defaultFilterIcon = t(locale.filterIcon) || /* @__PURE__ */React.createElement(FilterIcon$1, null);
  ...
  return /* @__PURE__ */React.createElement("div", {
    className: classNames([tableFilterClasses.icon, _defineProperty({}, isFocusClass, isObjectTrue || isValueExist)])
  ...
  }, props.popupProps), /* @__PURE__ */React.createElement("div", {
