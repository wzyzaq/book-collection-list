...
import { T as TreeStore } from '../_chunks/dep-a9366744.js';
...
var useCascaderContext = function useCascaderContext(props) {
  ...
  var optionCurrent = useRef(options);
  useEffect(function () {
  ...
  var getCascaderItems = function getCascaderItems(arrValue) {
    ...
    arrValue.forEach(function (value) {
      var nodes = treeStore2 === null || treeStore2 === void 0 ? void 0 : treeStore2.getNodes(value);
