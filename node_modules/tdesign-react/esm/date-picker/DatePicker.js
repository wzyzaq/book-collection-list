...
import { g as getDefaultFormat, f as formatDate, p as parseToDayjs, a as formatTime } from '../_chunks/dep-eeaa9b1c.js';
import { c as covertToDate, s as subtractMonth, a as addMonth, e as extractTimeObj, i as isSame } from '../_chunks/dep-9aece12b.js';
...
var DatePicker = /*#__PURE__*/forwardRef(function (originalProps, ref) {
  ...
  var panelProps = {
    ...
    onPanelClick: function onPanelClick() {
      ...
      return (_inputRef$current = inputRef.current) === null || _inputRef$current === void 0 || (_inputRef$current$foc = _inputRef$current.focus) === null || _inputRef$current$foc === void 0 ? void 0 : _inputRef$current$foc.call(_inputRef$current);
    },
