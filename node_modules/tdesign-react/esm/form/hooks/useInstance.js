...
import { _ as _asyncToGenerator, r as regenerator } from '../../_chunks/dep-4e82f065.js';
...
function useInstance(props, formRef, formMapRef, floatingFormDataRef) {
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            list = _toConsumableArray(formMapRef.current.values()).filter(function (formItemRef) {
              ...
              return isFunction(formItemRef === null || formItemRef === void 0 || (_formItemRef$current18 = formItemRef.current) === null || _formItemRef$current18 === void 0 ? void 0 : _formItemRef$current18.validate) && needValidate(formItemRef === null || formItemRef === void 0 || (_formItemRef$current19 = formItemRef.current) === null || _formItemRef$current19 === void 0 ? void 0 : _formItemRef$current19.name, fields);
      ...
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            list = _toConsumableArray(formMapRef.current.values()).filter(function (formItemRef) {
              var _formItemRef$current20, _formItemRef$current21;
              return isFunction(formItemRef === null || formItemRef === void 0 || (_formItemRef$current20 = formItemRef.current) === null || _formItemRef$current20 === void 0 ? void 0 : _formItemRef$current20.validateOnly) && needValidate(formItemRef === null || formItemRef === void 0 || (_formItemRef$current21 = formItemRef.current) === null || _formItemRef$current21 === void 0 ? void 0 : _formItemRef$current21.name, fields);
            }).map(function (formItemRef) {
              var _formItemRef$current$5, _formItemRef$current22;
              return formItemRef === null || formItemRef === void 0 || (_formItemRef$current$5 = (_formItemRef$current22 = formItemRef.current).validateOnly) === null || _formItemRef$current$5 === void 0 ? void 0 : _formItemRef$current$5.call(_formItemRef$current22, trigger);
            });
            _context2.next = 4;
            return Promise.all(list);
          case 4:
  ...
  function setValidateMessage(message) {
    travelMapFromObject(message, formMapRef, function (formItemRef, fieldValue) {
      ...
      formItemRef === null || formItemRef === void 0 || (_formItemRef$current10 = formItemRef.current) === null || _formItemRef$current10 === void 0 || (_formItemRef$current11 = _formItemRef$current10.setValidateMessage) === null || _formItemRef$current11 === void 0 || _formItemRef$current11.call(_formItemRef$current10, fieldValue);
    });
  }
  function getValidateMessage(fields) {
    ...
    if (typeof fields === "undefined") {
      _toConsumableArray(formMapRef.current.values()).forEach(function (formItemRef) {
        ...
        message[formItemRef === null || formItemRef === void 0 || (_formItemRef$current14 = formItemRef.current) === null || _formItemRef$current14 === void 0 ? void 0 : _formItemRef$current14.name] = item;
      });
    } else {
      if (!Array.isArray(fields)) throw new Error("getValidateMessage \u53C2\u6570\u9700\u8981 Array \u7C7B\u578B");
      fields.forEach(function (name) {
        var _formItemRef$current15, _formItemRef$current16, _formItemRef$current17;
        var formItemRef = getMapValue(name, formMapRef);
        var item = formItemRef === null || formItemRef === void 0 || (_formItemRef$current15 = formItemRef.current) === null || _formItemRef$current15 === void 0 || (_formItemRef$current16 = _formItemRef$current15.getValidateMessage) === null || _formItemRef$current16 === void 0 ? void 0 : _formItemRef$current16.call(_formItemRef$current15);
        if (isEmpty(item)) return;
        message[formItemRef === null || formItemRef === void 0 || (_formItemRef$current17 = formItemRef.current) === null || _formItemRef$current17 === void 0 ? void 0 : _formItemRef$current17.name] = item;
      });
    }
