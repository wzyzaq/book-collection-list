...
import { getCssVarsValue, canUseDocument } from '../_util/dom.js';
...
var Row = /*#__PURE__*/forwardRef(function (props, ref) {
  var _useDefaultProps = useDefaultProps(props, rowDefaultProps),
    ...
    otherRowProps = _objectWithoutProperties(_useDefaultProps, _excluded);
  ...
  var rowClassNames = classNames("".concat(classPrefix, "-row"), className, _defineProperty(_defineProperty({}, "".concat(classPrefix, "-row--").concat(justify), true), "".concat(classPrefix, "-row--").concat(align), true));
