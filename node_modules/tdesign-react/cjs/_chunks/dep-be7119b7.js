...
function getUnicodeLength(str) {
  return toConsumableArray._toConsumableArray(str !== null && str !== void 0 ? str : "").length;
}
function limitUnicodeMaxLength(str, maxLength, oldStr) {
  if (toConsumableArray._toConsumableArray(oldStr !== null && oldStr !== void 0 ? oldStr : "").slice().length === maxLength) return oldStr || "";
  return toConsumableArray._toConsumableArray(str !== null && str !== void 0 ? str : "").slice(0, maxLength).join("");
}
...
//# sourceMappingURL=dep-be7119b7.js.map
