...
var index = require('./dep-2b39f9ea.js');
var toConsumableArray = require('./dep-b691f3a6.js');
var createClass = require('./dep-e711efe7.js');
var log = require('./dep-e831f387.js');
var pick = require('./dep-3c90fe9e.js');
var isBoolean = require('./dep-ee985280.js');
var omit = require('./dep-be9ef47b.js');
var isUndefined = require('./dep-0f33907c.js');
var isNumber = require('./dep-ca323c2b.js');
var get = require('./dep-e831607b.js');
var isNull = require('./dep-cf41431c.js');
var toString = require('./dep-fff57180.js');
var isNil = require('./dep-d554fd33.js');
var isFunction = require('./dep-d4fd8ae6.js');
...
function getExposedProps(node) {
  var props = pick.pick(node, ["value", "label", "data", "actived", "expanded", "checked", "indeterminate", "loading"]);
  return props;
}
function createNodeModel(node) {
  var props = getExposedProps(node);
  var model = _objectSpread$1(_objectSpread$1({}, props), {}, {
...
var TreeNode = /*#__PURE__*/function () {
  function TreeNode(tree, data, parent) {
    var _this = this;
    createClass._classCallCheck(this, TreeNode);
    this.data = data;
    this.tree = tree;
  ...
  return createClass._createClass(TreeNode, [{
    key: "initChecked",
...
//# sourceMappingURL=dep-4bcd9f4d.js.map
