...
var treeNode = require('./dep-4bcd9f4d.js');
var isFunction = require('./dep-d4fd8ae6.js');
var isString = require('./dep-b2af1b16.js');
var isNumber = require('./dep-ca323c2b.js');
var isPlainObject = require('./dep-54d84720.js');
var isArray = require('./dep-cef99009.js');
var difference = require('./dep-f9e97518.js');
var camelCase = require('./dep-10ac59e4.js');
...
var TreeStore = /*#__PURE__*/function () {
  function TreeStore(options) {
    createClass._classCallCheck(this, TreeStore);
  ...
  return createClass._createClass(TreeStore, [{
    key: "setConfig",
    ...
    value: function replaceExpanded(list) {
      ...
      var added = difference.difference(list, expanded);
      var removed = difference.difference(expanded, list);
...
//# sourceMappingURL=dep-64ccb386.js.map
