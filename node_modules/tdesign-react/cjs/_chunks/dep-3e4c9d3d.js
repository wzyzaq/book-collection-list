...
var _cacheHas = require('./dep-9bee38bb.js');
var _baseGetTag = require('./dep-5dc79997.js');
var eq = require('./dep-7ffb0d81.js');
var _setToArray = require('./dep-0ba932e9.js');
...
function equalByTag(object, other, tag, bitmask, customizer, equalFunc, stack) {
  switch (tag) {
    case dataViewTag:
      ...
      other = other.buffer;
    case arrayBufferTag:
      if (object.byteLength != other.byteLength || !equalFunc(new _Uint8Array.Uint8Array(object), new _Uint8Array.Uint8Array(other))) {
        return false;
      }
      return true;
    case boolTag:
...
function equalObjects(object, other, bitmask, customizer, equalFunc, stack) {
  var isPartial = bitmask & COMPARE_PARTIAL_FLAG$1,
    objProps = _getAllKeys.getAllKeys(object),
    objLength = objProps.length,
    othProps = _getAllKeys.getAllKeys(other),
...
//# sourceMappingURL=dep-3e4c9d3d.js.map
