...
var log = require('./dep-e831f387.js');
var isObject = require('./dep-de258415.js');
var isString = require('./dep-b2af1b16.js');
var isNumber = require('./dep-ca323c2b.js');
...
function largePositiveNumberAdd(num1, num2) {
  var _num1$split = num1.split("."),
    _num1$split2 = slicedToArray._slicedToArray(_num1$split, 2),
  ...
  var _num2$split = num2.split("."),
    _num2$split2 = slicedToArray._slicedToArray(_num2$split, 2),
...
function formatENumber(num) {
  var _num$split = num.split("e"),
    _num$split2 = slicedToArray._slicedToArray(_num$split, 2),
    num1 = _num$split2[0],
    num2 = _num$split2[1];
  if (!num2) return num;
  var _num$split3 = num.split("."),
    _num$split4 = slicedToArray._slicedToArray(_num$split3, 2),
  ...
  var _initDecimal$split = initDecimal.split("e"),
    _initDecimal$split2 = slicedToArray._slicedToArray(_initDecimal$split, 1),
...
function compareLargeNumber(num1, num2) {
  var _formatENumber$split = formatENumber(num1).split("."),
    _formatENumber$split2 = slicedToArray._slicedToArray(_formatENumber$split, 2),
    integer1 = _formatENumber$split2[0],
    decimal1 = _formatENumber$split2[1];
  var _formatENumber$split3 = formatENumber(num2).split("."),
    _formatENumber$split4 = slicedToArray._slicedToArray(_formatENumber$split3, 2),
...
function largePositiveNumberSubtract(num1, num2) {
  ...
  var _maxNumber$split = maxNumber.split("."),
    _maxNumber$split2 = slicedToArray._slicedToArray(_maxNumber$split, 2),
  ...
  var _minNumber$split = minNumber.split("."),
    _minNumber$split2 = slicedToArray._slicedToArray(_minNumber$split, 2),
...
function formatDecimal(num, places) {
  ...
  var _num$toString$split = num.toString().split("."),
    _num$toString$split2 = slicedToArray._slicedToArray(_num$toString$split, 2),
...
function largeNumberToFixed(number) {
  ...
  var _number$split = number.split("."),
    _number$split2 = slicedToArray._slicedToArray(_number$split, 2),
...
//# sourceMappingURL=dep-68a3b90a.js.map
