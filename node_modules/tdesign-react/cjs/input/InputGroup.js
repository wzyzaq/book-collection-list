...
var InputGroup = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var separate = props.separate,
    ...
    wrapperProps = objectWithoutProperties._objectWithoutProperties(props, _excluded);
  return /* @__PURE__ */React__default["default"].createElement("div", _objectSpread({
    ref: ref,
    className: classNames__default["default"]("".concat(classPrefix, "-input-group"), className, defineProperty._defineProperty({}, "".concat(classPrefix, "-input-group--separate"), separate))
