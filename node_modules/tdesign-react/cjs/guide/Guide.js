...
var loading_gradient = require('../_chunks/dep-05ad44c3.js');
...
var Guide = function Guide(originalProps) {
  ...
  var setHighlightLayerPosition = function setHighlightLayerPosition(highlightLayer) {
    ...
    if (isPopup) {
      ...
      var _getWindowScroll = _util_dom.getWindowScroll(),
        scrollTop = _getWindowScroll.scrollTop,
        scrollLeft = _getWindowScroll.scrollLeft;
      top += scrollTop;
      left += scrollLeft;
    }
    loading_gradient.setStyle(highlightLayer, {
  ...
  if (!_util_dom.canUseDocument) {
    return null;
  }
  var currentElmIsFixed = _util_dom.isFixed(currentHighlightLayerElm.current || document.body);
