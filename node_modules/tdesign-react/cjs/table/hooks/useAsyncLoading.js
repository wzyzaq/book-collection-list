...
function useAsyncLoading(props) {
  ...
  var classes = [asyncLoadingClass, defineProperty._defineProperty(defineProperty._defineProperty({}, isLoadingClass, props.asyncLoading === "loading"), isLoadMoreClass, props.asyncLoading === "load-more")];
